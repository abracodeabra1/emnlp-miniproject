...
\midrule
Krippendorff $\alpha$ & 0.878 & 0.615 & 0.893 & 0.888 \\
Cohen $\kappa$ (mean pair) & 0.882 & 0.642 & 0.888 & 0.886 \\
\bottomrule
\end{tabular}
\caption{Inter-annotator agreement on the study subset ($n{=}50$ articles, three annotators).}
\label{tab:iaa}
\end{table}
